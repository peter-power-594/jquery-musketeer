 ...
 */
!function(t,n){"function"==typeof define&&define.amd?define(["jquery"],n):"object"==typeof exports?module.exports=n(require("jquery")):t.musketeer=n(t.jQuery)}(this,function(w){function t(t){this.init()}function s(t){t=t.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0];return w("<head />").html(w.parseHTML(t,document,!0))}return w.parseJSON||(w.parseJSON=function(t){var n;try{n=JSON.parse(t)}catch(t){window.console&&window.console.log&&window.console.log(t),n=null}return n}),t.defaults={debug:"0",i18n:{},barbajs:{head:["meta[name='keywords']","meta[name='description']","meta[property^='og']","meta[name^='twitter']","meta[itemprop]","link[itemprop]","link[rel='prev']","link[rel='next']","link[rel='canonical']","script[ lang ]"].join(",")}},t.prototype.log=function(){},t.prototype.init=function(){var n=this;w(document).ready(function(){var t=w("#musketeer-options");t.length?n.options=w.extend(!0,n.constructor.defaults,w.parseJSON(t.html())):n.options?n.options=w.extend(!0,n.constructor.defaults,n.options):n.options=n.constructor.defaults,n.options.debug=parseInt(n.options.debug||0,10),!isNaN(n.options.debug)&&0<n.options.debug&&(n.log=function(t,n){1===arguments.length?window.console&&window.console.log&&window.console.log("jQuery Musketeer: "+t):window.console&&window.console[t]&&window.console[t]("jQuery Musketeer: "+n)}),n.lang=w.yaJsStorage.get("lang",n.options.i18n.base),n.getRemoteData(function(){n.i18n()}),n.pjaxify()})},t.prototype.url2path=function(t){t=(t||"").replace([window.location.protocol,"//",window.location.host].join(""),"");return t=(t=t.replace(/\?.*/,"")).replace(/#.*/,"")},t.prototype.urlfaker=function(t){var n=this,e=(n.log("info","urlfaker("+(t||"")+")"),window.location.protocol,window.location.host),o=window.location.pathname,a=window.location.search,i=window.location.hash;return t?(o=n.url2path(t),a=/\?/.test(t)?"?"+t.split("?")[1].split("#")[0]:"",i=/#/.test(t)?"#"+t.split("#")[1]:""):t=document.location.href,w.each(n.options.i18n.langs,function(){o=o.replace(new RegExp("^/"+this.toString()+"/"),"/")}),/lang/.test(a||"")&&(a=a.replace(/lang\=[a-zA-Z-_]+/,"")).length<2&&(a=""),-1<w.inArray((i||"").replace("#",""),n.options.i18n.langs)&&(i=""),n.lang!==n.options.i18n.base&&(e+="/"+n.lang),t=[window.location.protocol,"//",e,o,a,i].join(""),n.log("The following url was generated:"+t),t},t.prototype.urlunfaker=function(){var t=this,n=(t.log("info","urlunfaker()"),window.location.protocol),e=window.location.host,o=window.location.pathname,a=window.location.search,i=window.location.hash;return w.each(t.options.i18n.langs,function(){var t=this.toString(),n=new RegExp("^/"+t+"/");if(n.test(o))return o=o.replace(n,"/"),a.length?a+="&lang="+t:a="?lang="+t,!0}),n=[n,"//",e,o,a,i].join(""),t.log("The following url was generated:"+n),n},t.prototype.triggerLang=function(t){w(this.options.i18n.menu).find("a[ lang='"+t+"' ],a[ hreflang='"+t+"' ]").trigger("click")},t.prototype.pjaxify=function(){var r=this,l=document.documentElement||{};if(!window.Barba||!this.options.barbajs)return!1;Barba.Pjax.cacheEnabled=!1;var a="",i=(Barba.Pjax.getCurrentUrl=function(){return a},!(Barba.Pjax.goTo=function(t){r.log("info","Barbar.Pjax.goTo("+t+")"),a=t,Barba.Pjax.onStateChange(),window.history.pushState(null,null,r.urlfaker(t))}));Barba.Dispatcher.on("linkClicked",function(t,n){i=!0}),Barba.Pjax.originalOnStateChange=Barba.Pjax.onStateChange,Barba.Pjax.onStateChange=function(){if(i)Barba.Pjax.originalOnStateChange.call(this),i=!1;else{r.log("warn","URL requested from browser back / next buttons");var n=window.location.pathname.replace(/index\.\w+$/,""),e=r.url2path(a).replace(/index\.\w+$/,""),o=0;if(n===e)return r.triggerLang(r.options.i18n.base);w.each(r.options.i18n.langs,function(){var t=new RegExp("^/"+this.toString()+"/");if(t.test(n)&&new RegExp(n.replace(t,"/"))===e)return o=1,r.triggerLang(this.toString()),!1}),0<o||(Barba.Dispatcher.trigger("linkClicked"),a=r.urlunfaker(),Barba.Pjax.onStateChange())}},Barba.Pjax.start(),Barba.Dispatcher.on("newPageReady",function(t,n,e,o){var o=s(o),a=r.options.barbajs.head,i=(w("head").find(a).remove(),o.find(a).appendTo("head"),l.lang||"en");r.getRemoteData(function(){r.triggerLang(i)}),window.ga&&window.ga("send","pageview",window.location.pathname+window.location.search)})},t.prototype.i18n=function(){var d,p,u,n,e,t;return!!(this.options&&this.options.i18n&&this.options.i18n.langs&&this.options.i18n.langs.length)&&(d=function(){if(!window.Barba)return!0;var t=w("."+Barba.Pjax.Dom.containerClass),n=window.twttr||!1,e=window.FB||!1,o=window.gapi||!1;n&&n.widgets&&n.widgets.load(t[t.length-1]),e&&e.XFBML&&e.XFBML.parse(t[t.length-1]),o&&o.plusone&&o.plusone.go()},p=this,(u=document.documentElement||{}).lang=u.lang||"en",n=function(t){p.log("info","Switching Language to "+t),w(document).trigger("musketeer:ready"),p.lang=t,w.yaJsStorage.set("lang",t);var n=w("body"),e=(n.hasClass(p.lang)||(n.removeClass(u.lang),u.lang=p.lang,n.addClass(p.lang)),p.urlfaker()),e=(e!==document.location.href&&window.history&&window.history.pushState&&window.history.pushState(null,null,e),w("#head-"+t));if(e.length){var o,a=w.parseJSON(e.html()),i=w("head");for(o in w("head").find(p.options.barbajs.head).filter(":not( script )").remove(),a)if(a.hasOwnProperty(o))if(/title/.test(o))document.title=a[o];else for(var r,l,s=a[o],c=0,g=s.length;c<g;c++){for(var h in r="<"+o,l=s[c])r+=" "+h+'="'+l[h]+'"';r+=">",i.append(r)}}w.each(p.options.i18n.langs,function(){(t=this.toString())!==p.lang&&n.find(p.options.i18n.selector.replace("%lang",t)).each(function(){var t=w(this);t.length&&!/script/.test((t[0].tagName||"").toLowerCase())&&(w(this).children().length&&w(this).data("cached",w(this).html()),w(this).empty().css("display","none"))})}),n.find(p.options.i18n.selector.replace("%lang",p.lang)).each(function(){var t,n=w(this);n.length&&(/script/.test((n[0].tagName||"").toLowerCase())?(t=w.parseJSON(n.html()))&&t.id&&t.content&&w("#"+t.id).html(t.content).data("cached",null):!n.children().length&&n.data("cached")&&n.html(n.data("cached")).css("display","block").data("cached",null))}),d(),w(document).trigger("musketeer:complete")},this.options.i18n.menu&&(e=w(this.options.i18n.menu)).on("click","a",function(t){t.preventDefault(),n(w(this).attr("hreflang")||w(this).attr("lang")),e.find(".ui-state-active").removeClass("ui-state-active"),w(this).addClass("ui-state-active")}),t=[],void((t=/lang/.test(document.location.href)?document.location.href.match(/lang\=([a-zA-Z_-]+)/):window.location.hash&&1<window.location.hash.length?window.location.hash.match(/\#([a-zA-Z_-]+)/):window.location.pathname.match(/^\/([a-zA-Z_-]+)\//))&&t.length&&t[1]&&-1<w.inArray(t[1],this.options.i18n.langs)?p.triggerLang(t[1]):n(w.yaJsStorage.get("lang",u.lang))))},t.prototype.getRemoteData=function(a){var i=this,t=w("[data-remote]"),r=t.length;if(r<1)return a&&"function"==typeof a&&a(),1;t.each(function(){var t,n,e=w(this),o=e.attr("id")||!1;o?(t=function(t){r--,e.html(w((n=(n=t).match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0],w("<div />").html(w.parseHTML(n,document,!0)))).find("#"+o).html());var n=w(s(t)).find("script[lang]");n.length&&(w("#"+n.attr("id")).remove(),w("head").append(n)),r<1&&a&&"function"==typeof a&&a()},n=function(t){i.log(t.message)},window.Barba?Barba.Utils.xhr(e.attr("data-remote")).then(t,n):w.ajax({url:e.attr("data-remote"),success:t,error:n}),e.removeAttr("data-remote")):(i.log("warn","Missing id attribute on el"+e),e.remove())})},new t});