 ...
 */
!function(t,n){"function"==typeof define&&define.amd?define(["jquery"],n):"object"==typeof exports?module.exports=n(require("jquery")):t.musketeer=n(t.jQuery)}(this,function(f){function t(t){this.init()}function s(t){t=t.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0];return f("<head />").html(f.parseHTML(t,document,!0))}return f.parseJSON||(f.parseJSON=function(t){var n;try{n=JSON.parse(t)}catch(t){window.console&&window.console.log&&window.console.log(t),n=null}return n}),t.defaults={debug:"0",i18n:{},barbajs:{head:["meta[name='keywords']","meta[name='description']","meta[property^='og']","meta[name^='twitter']","meta[itemprop]","link[itemprop]","link[rel='prev']","link[rel='next']","link[rel='canonical']","script[ lang ]"].join(",")}},t.prototype.log=function(){},t.prototype.init=function(){var n=this;f(document).ready(function(){var t=f("#musketeer-options");t.length?n.options=f.extend(!0,n.constructor.defaults,f.parseJSON(t.html())):n.options?n.options=f.extend(!0,n.constructor.defaults,n.options):n.options=n.constructor.defaults,n.options.debug=parseInt(n.options.debug||0,10),!isNaN(n.options.debug)&&0<n.options.debug&&(n.log=function(t,n){1===arguments.length?window.console&&window.console.log&&window.console.log("jQuery Musketeer: "+t):window.console&&window.console[t]&&window.console[t]("jQuery Musketeer: "+n)}),n.lang=f.yaJsStorage.get("lang",n.options.i18n.base),n.getRemoteData(function(){n.i18n()}),n.pjaxify()})},t.prototype.url2path=function(t){t=(t||"").replace([window.location.protocol,"//",window.location.host].join(""),"");return t=(t=t.replace(/\?.*/,"")).replace(/#.*/,"")},t.prototype.urlfaker=function(t){var n=this,e=(n.log("info","urlfaker("+(t||"")+")"),window.location.protocol,window.location.host),a=window.location.pathname,o=window.location.search,i=window.location.hash;return t?(a=n.url2path(t),o=/\?/.test(t)?"?"+t.split("?")[1].split("#")[0]:"",i=/#/.test(t)?"#"+t.split("#")[1]:""):t=document.location.href,f.each(n.options.i18n.langs,function(){a=a.replace(new RegExp("^/"+this.toString().replace(/[_-]+.*$/,"")+"/"),"/")}),/lang/.test(o||"")&&(o=o.replace(/lang\=[a-zA-Z-_]+/,"")).length<2&&(o=""),-1<f.inArray((i||"").replace("#",""),n.options.i18n.langs)&&(i=""),n.lang!==n.options.i18n.base&&(e+="/"+n.lang.replace(/[_-]+.*$/,"")),t=[window.location.protocol,"//",e,a,o,i].join(""),n.log("The following url was generated:"+t),t},t.prototype.urlunfaker=function(){var t=this,n=(t.log("info","urlunfaker()"),window.location.protocol),e=window.location.host,a=window.location.pathname,o=window.location.search,i=window.location.hash;return f.each(t.options.i18n.langs,function(){var t=this.toString().replace(/[_-]+.*$/,""),n=new RegExp("^/"+t+"/");if(n.test(a))return a=a.replace(n,"/"),o.length?o+="&lang="+t:o="?lang="+t,!0}),n=[n,"//",e,a,o,i].join(""),t.log("The following url was generated:"+n),n},t.prototype.triggerLang=function(t){f(this.options.i18n.menu).find("a[ lang='"+t+"' ],a[ hreflang='"+t+"' ]").trigger("click")},t.prototype.pjaxify=function(){var r=this,l=document.documentElement||{};if(!window.Barba||!this.options.barbajs)return!1;Barba.Pjax.cacheEnabled=!1;var o="",i=(Barba.Pjax.getCurrentUrl=function(){return o},!(Barba.Pjax.goTo=function(t){r.log("info","Barbar.Pjax.goTo("+t+")"),o=t,Barba.Pjax.onStateChange(),window.history.pushState(null,null,r.urlfaker(t))}));Barba.Dispatcher.on("linkClicked",function(t,n){i=!0}),Barba.Pjax.originalOnStateChange=Barba.Pjax.onStateChange,Barba.Pjax.onStateChange=function(){if(i)Barba.Pjax.originalOnStateChange.call(this),i=!1;else{r.log("warn","URL requested from browser back / next buttons");var n=window.location.pathname.replace(/index\.\w+$/,""),e=r.url2path(o).replace(/index\.\w+$/,""),a=0;if(n===e)return r.triggerLang(r.options.i18n.base);f.each(r.options.i18n.langs,function(){var t=new RegExp("^/"+this.toString()+"/");if(t.test(n)&&new RegExp(n.replace(t,"/"))===e)return a=1,r.triggerLang(this.toString()),!1}),0<a||(Barba.Dispatcher.trigger("linkClicked"),o=r.urlunfaker(),Barba.Pjax.onStateChange())}},Barba.Pjax.originalPreventCheck=Barba.Pjax.preventCheck,Barba.Pjax.preventCheck=function(t,n){return!!Barba.Pjax.originalPreventCheck(t,n)&&!/\.(pdf|jpg|jpeg|gif|png|webp|tiff|bmp|mov|webm|mp3|mp4|ogg|acc)/.test(n.href.toLowerCase())},Barba.Pjax.start(),Barba.Dispatcher.on("newPageReady",function(t,n,e,a){var a=s(a),o=r.options.barbajs.head,i=(f("head").find(o).remove(),a.find(o).appendTo("head"),l.lang||"en");r.getRemoteData(function(){r.triggerLang(i)}),window.ga&&window.ga("send","pageview",window.location.pathname+window.location.search)}),Barba.Dispatcher.on("transitionCompleted",function(t,n){f(document).trigger("musketeer:page_loaded")})},t.prototype.i18n=function(){var d,u,w,n,e,t;return!!(this.options&&this.options.i18n&&this.options.i18n.langs&&this.options.i18n.langs.length)&&(d=function(){if(!window.Barba)return!0;var t=f("."+Barba.Pjax.Dom.containerClass),n=window.twttr||!1,e=window.FB||!1,a=window.gapi||!1;n&&n.widgets&&n.widgets.load(t[t.length-1]),e&&e.XFBML&&e.XFBML.parse(t[t.length-1]),a&&a.plusone&&a.plusone.go()},u=this,(w=document.documentElement||{}).lang=w.lang||"en",n=function(t){u.log("info","Switching Language to "+t),f(document).trigger("musketeer:ready");var n=(t||"").replace(/[_-]+.*$/,""),e=f("body"),a=f(w),a=(a.hasClass(n)||(a.removeClass((u.lang||w.lang).replace(/[_-]+.*$/,"")),w.lang=t,a.addClass(n),u.lang=t,f.yaJsStorage.set("lang",t)),u.urlfaker()),n=(a!==document.location.href&&window.history&&window.history.pushState&&window.history.pushState(null,null,a),f("#head-"+t));if(n.length){var o,i=f.parseJSON(n.html()),r=f("head");for(o in f("head").find(u.options.barbajs.head).filter(":not( script )").remove(),i)if(i.hasOwnProperty(o))if(/title/.test(o))document.title=i[o];else for(var l,s,c=i[o],g=0,h=c.length;g<h;g++){for(var p in l="<"+o,s=c[g])l+=" "+p+'="'+s[p]+'"';l+=">",r.append(l)}}f.each(u.options.i18n.langs,function(){(t=this.toString())!==u.lang&&e.find(u.options.i18n.selector.replace("%lang",t)).each(function(){var t=f(this);t.length&&!/script/.test((t[0].tagName||"").toLowerCase())&&(f(this).children().length&&f(this).data("cached",f(this).html()),f(this).empty().css("display","none"))})}),e.find(u.options.i18n.selector.replace("%lang",u.lang)).each(function(){var t,n=f(this);n.length&&(/script/.test((n[0].tagName||"").toLowerCase())?(t=f.parseJSON(n.html()))&&t.id&&t.content&&f("#"+t.id).html(t.content).data("cached",null):!n.children().length&&n.data("cached")&&n.html(n.data("cached")).css("display","block").data("cached",null))}),d(),f(document).trigger("musketeer:complete")},this.options.i18n.menu&&(e=f(this.options.i18n.menu)).on("click","a",function(t){t.preventDefault(),n(f(this).attr("hreflang")||f(this).attr("lang")),e.find(".ui-state-active").removeClass("ui-state-active"),f(this).addClass("ui-state-active")}),t=[],void((t=/lang/.test(document.location.href)?document.location.href.match(/lang\=([a-zA-Z_-]+)/):window.location.hash&&1<window.location.hash.length?window.location.hash.match(/\#([a-zA-Z_-]+)/):window.location.pathname.match(/^\/([a-zA-Z_-]+)\//))&&t.length&&t[1]&&-1<f.inArray(t[1],this.options.i18n.langs)?u.triggerLang(t[1]):n(f.yaJsStorage.get("lang",w.lang))))},t.prototype.getRemoteData=function(o){var i=this,t=f("[data-remote]"),r=t.length;if(r<1)return o&&"function"==typeof o&&o(),1;t.each(function(){var t,n,e=f(this),a=e.attr("id")||!1;a?(t=function(t){r--,e.html(f((n=(n=t).match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0],f("<div />").html(f.parseHTML(n,document,!0)))).find("#"+a).html());var n=f(s(t)).find("script[lang]");n.length&&(f("#"+n.attr("id")).remove(),f("head").append(n)),r<1&&o&&"function"==typeof o&&o()},n=function(t){i.log(t.message)},window.Barba?Barba.Utils.xhr(e.attr("data-remote")).then(t,n):f.ajax({url:e.attr("data-remote"),success:t,error:n}),e.removeAttr("data-remote")):(i.log("warn","Missing id attribute on el"+e),e.remove())})},new t});